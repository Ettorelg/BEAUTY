...
export const locations = pgTable(
  ...
  (table) => [
    index("locations_business_idx").on(table.businessId),
    uniqueIndex("locations_business_name_unique").on(table.businessId, table.name),
  ],
);
...
export const businessMemberships = pgTable(
  ...
  (table) => [
    uniqueIndex("memberships_business_user_unique").on(table.businessId, table.userId),
