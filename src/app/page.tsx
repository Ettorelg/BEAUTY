    ...
    <main>
      <section className="card">
        <div style={{ marginBottom: 18 }}>
          <Image src="/brand/alpha-prenota-logo-v1.png" alt="Logo Alpha Prenota" width={420} height={140} priority style={{ width: "min(100%, 420px)", height: "auto" }} />
        </div>
        <h1>I tuoi appuntamenti, più semplici.</h1>
        <p>Prenotazioni, agenda, clienti e fidelizzazione in un unico spazio, per professionisti di ogni settore.</p>
