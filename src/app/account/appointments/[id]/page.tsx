...
export default async function CustomerReschedulePage({ params, searchParams }: { params: Promise<{ id: string }>; searchParams: Promise<{ date?: string }> }) {
  ...
  return <main className="customer-shell"><header className="app-header"><div><p className="eyebrow">Alpha Prenota · Area clienti</p><strong>Modifica prenotazione</strong></div><Link className="ghost-button link-button" href="/account">Torna alle prenotazioni</Link></header>
