...
export default async function AdminLicensesPage() {
  ...
  return <main className="dashboard-shell">
    ...
    <nav className="app-nav"><Link href="/app">Gestionale</Link><Link href="/admin/licenses">Tutte le licenze</Link></nav>
