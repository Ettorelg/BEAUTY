...
export default async function ServicesPage() {
  ...
  const catalog = await db.select({
    ...
    price: services.price, repeatPrice: services.repeatPrice, repeatPriceEnabled: services.repeatPriceEnabled, onlineBookable: services.onlineBookable, categoryName: serviceCategories.name,
